      ...
      <div className="container px-5 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
        <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left md:mt-0 mt-10">
          <Link href="" className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
            ...
            <span className="ml-3 text-xl">InvestJar</span>
          </Link>
          {/* <p className="mt-2 text-sm text-gray-500">Air plant banjo lyft occupy retro adaptogen indego</p> */}
        </div>
        {/* <div className="flex-grow flex flex-wrap md:pr-20 -mb-10 md:text-left text-center order-first">
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            <h2 className="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">About InvestJar</h2>
          ...
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <ul className="list-none mb-10">
              <li>
                <Link href="" className="text-gray-600 hover:text-gray-800">Manage Your Account</Link>
              </li>
              <li>
                <Link href="" className="text-gray-600 hover:text-gray-800">Investments</Link>
              </li>
              <li>
                <Link href="" className="text-gray-600 hover:text-gray-800">Account Verification</Link>
              </li>
              <li>
                <Link href="" className="text-gray-600 hover:text-gray-800">Safety & Security</Link>
              </li>
            </ul>
          </div>

          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            <h2 className="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">Legal Info</h2>
            <ul className="list-none mb-10">
              <li>
