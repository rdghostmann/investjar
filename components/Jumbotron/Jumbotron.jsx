...
export default function Jumbotron() {
  return (
    <div
      className="relative isolate px-10 py-10 sm:px-6 lg:px-8 ">
      <div
        aria-hidden="true"
      ...
      src={myBgImg} 
      alt=''
      className='absolute top-0 left-0 -z-10 w-full bg-cover bg-center repeat-0'
       />  */}
      <div className="mx-auto max-w-xl ">
        ...
        <div className="text-center">
          ...
          <div className="mt-6 flex flex-col items-center gap-y-4 sm:flex-row sm:justify-center sm:gap-x-6">
            ...
            >
              Get started<span className="ml-4" aria-hidden="true">&rarr;</span>
            </Link>
          </div>
        </div>
      </div>
